...
export default function GridStats(){
    return(
        <section className="space-y-4 md:space-y-8 w-full max-w-6xl mx-auto px-4">
                <header className="space-y-1.5">
                    <H1 className="font-bold">Explore</H1>
                    <P14 className="text-gray-60">Review protocol stats and activity</P14>
                </header>
                <div className="grid grid-cols-4 gap-2 md:gap-8 w-full max-w-2xl mx-auto text-center border-[1.5px] border-gray-40 p-1 md:p-2">
                    <BorderEdges cornerColor="#6E54FF" cornerThickness={2}>
                        <div className="p-1 md:p-2 space-y-2.5 text-center">
